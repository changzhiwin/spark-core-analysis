...
import xyz.sourcecodestudy.spark.rpc.{ThreadSafeRpcEndpoint, IsolatedRpcEndpoint, RpcEndpointRef, RpcEnv, RpcCallContext}
...
object Foobar {
  ...
  def main(args: Array[String]) = {
    ...
    val rpcEnv = RpcEnv.create("FoobarEnv", "127.0.0.1", 9999, null.asInstanceOf[SparkConf], 1)
