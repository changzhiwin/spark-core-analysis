...
class NettyRpcEnv(
  ...
  val transportConf = new TransportConf("rpc", getConfigFromSparkConf)
  ...
  val clientConnectionExecutor = ThreadUtils.newDaemonCachedThreadPool("netty-rpc-connection", 4)
